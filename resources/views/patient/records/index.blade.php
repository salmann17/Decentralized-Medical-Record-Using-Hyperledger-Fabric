                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex flex-col items-end">
                            ...
                            @if($isValid)
                                <span class="text-xs text-green-600 mt-1 flex items-center font-medium">
                            ...
                            @elseif($isInvalid)
                                <span class="text-xs text-red-600 mt-1 flex items-center font-medium">
                                    <svg class="mr-1 h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            @elseif($isNotFound)
                                <span class="text-xs text-yellow-600 mt-1 flex items-center font-medium">
                                    <svg class="mr-1 h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
